...
import pandas as pd
from reidentification_utils import find_closest_neighbors_Pyradiomics, print_results, compute_precision_recall
...
if __name__ == "__main__":
    ...
    output_dir = "./Pyradiomics_reidentification_analysis"

    results_lists = []

    for standardize in [False, True]:
        for features_group in ["All" , "Texture", "Shape"]:
            results = find_closest_neighbors_Pyradiomics(
